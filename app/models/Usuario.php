...
class Usuario
{
    ...
    public function crearUsuario()
    {
        ...
        $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO usuarios (sueldo, sector, fechaIngreso, nombreUsuario, idProducto) VALUES (:sueldo, :sector, :fechaIngreso, :nombreUsuario, :idProducto)");
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT sueldo, sector, fechaIngreso, nombreUsuario, idProducto, idUsuario FROM usuarios");
        $consulta->execute();
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT sueldo, sector, fechaIngreso, nombreUsuario, idProducto, idUsuario FROM usuarios WHERE idUsuario = :idUsuario");
